...
//Validation
const validateAdminRegisterInput = require('../validateInputs/adminRegister')
const validateFacultyRegisterInput = require('../validateInputs/facultyRegister')
const validateStudentRegisterInput = require('../validateInputs/studentRegister')
const validateAdminLoginInput = require('../validateInputs/adminLogin')
const validateSubjectRegisterInput = require('../validateInputs/subjectRegister')

...
//File Handler
const bufferConversion = require('../utilities/bufferConversion')
const cloudinary = require('../utilities/cloudinary')

const validateFacultyLoginInput = require('../validateInputs/facultyLogin')
const validateFetchStudentsInput = require('../validateInputs/facultyFetchStudent')
const validateFacultyUpdatePassword = require('../validateInputs/FacultyUpdatePassword')
const validateForgotPassword = require('../validateInputs/forgotPassword')
const validateOTP = require('../validateInputs/otpValidation')
const validateFacultyUploadMarks = require('../validateInputs/facultyUploadMarks')
